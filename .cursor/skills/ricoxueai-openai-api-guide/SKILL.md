...
本技能用于指导如何在保持 OpenAI 协议不变的前提下，将现有项目或工具快速切换到超级斜杠 API 网关（`https://api.ricoxueai.cn`）。注意，这些调用都是兼容OpenAI的，OpenAI官方文档https://developers.openai.com/api/reference/resources/chat
